...
lock tables  cidade write, cozinha write, estado write, forma_pagamento write, 
		grupo write, grupo_permissao write, produto write, restaurante write, 
		...
		foto_produto write, permissao write, oauth_client_details write; 
...
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$10$OgQFGs5W8qTkETM.tsrdle5GYEOA2gTK0LaYs0x9K0FpwmrwkcZ1G', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$10$OgQFGs5W8qTkETM.tsrdle5GYEOA2gTK0LaYs0x9K0FpwmrwkcZ1G', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$10$OgQFGs5W8qTkETM.tsrdle5GYEOA2gTK0LaYs0x9K0FpwmrwkcZ1G', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$10$OgQFGs5W8qTkETM.tsrdle5GYEOA2gTK0LaYs0x9K0FpwmrwkcZ1G', utc_timestamp),
...
values (
  'foodanalytics', null, '$2y$12$LHljYlos11Go1Va7pggIzu4Bpx1UGKblqPg0v7cNEJ1RNj4JaZaGq',
