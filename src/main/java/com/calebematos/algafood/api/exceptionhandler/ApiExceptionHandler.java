...
import com.calebematos.algafood.api.exceptionhandler.Problem.ProblemBuilder;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICO_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema. Tente novamente e se o problema persistir, entre em contato com o administrador do sistema.";
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		if (rootCause instanceof InvalidFormatException) {
			return handlerIvalidFormatException((InvalidFormatException) rootCause, headers, status, request);
		}
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		String detail = String.format(
				"O parâmetro de URL '%s' recebeu o valor '%s', que é um tipo iválido. "
	...
	private ResponseEntity<Object> handlerIvalidFormatException(InvalidFormatException ex, HttpHeaders headers,
			HttpStatus status, WebRequest request) {
	...
	private String joinPath(List<Reference> references) {
		return references.stream().map(ref -> ref.getFieldName()).collect(joining("."));
	}
