...
import static com.calebematos.algafood.infrastructure.repository.spec.RestauranteSpecs.comFreteGratis;
import static com.calebematos.algafood.infrastructure.repository.spec.RestauranteSpecs.comNomeSemelhante;
...
import com.calebematos.algafood.domain.repository.RestauranteRepositoryQuery;
...
public class RestauranteRepositoryImpl implements RestauranteRepositoryQuery {
	...
	public List<Restaurante> find(String nome, BigDecimal taxaFreteInicial, BigDecimal taxaFreteFinal) {
		...
		if(StringUtils.hasText(nome)) {
			predicates.add(builder.like(root.get("nomne"), "%" + nome + "%"));
		}
